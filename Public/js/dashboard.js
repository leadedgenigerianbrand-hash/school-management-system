...
function updateDashboardStatistics(stats) {
    ...
    Object.keys(mappings).forEach(
        function (targetId) {
            ...
            for (
                const key of mappings[targetId]
            ) {
                if (
        ...
        .forEach(
            function (student) {
                ...
                row.innerHTML =
                    ...
                    "<td>" +
                    '<a href="/pages/student-profile.html?id=' +
